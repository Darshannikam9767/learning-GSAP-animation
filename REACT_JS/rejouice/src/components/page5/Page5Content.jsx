...
const Page5Content = () => {
    ...
    return (
        <div className='mainDiv h-full w-[96%] ml-[2%] mt-[10vh] md:mt-[7vh] lg:mt-[5vh]'>
            <form className='flex flex-col items-start gap-[2vh] md:ml-[10%] md:w-[80%] lg:w-[80%]'>
                ...
                <textarea className='anima border-gray-400 rounded-xl border-2  outline-0 px-3 py-2 w-full mt-[4vh] h-[20vh] focus:border-gray-500' placeholder='Drop your message'></textarea>
